...
![JetBrains AI chat с моделями стороннего BYOK-провайдера](../../images/jetbrains/jetbrains-ides-byok-chat.webp)
...
![Старая настройка BYOK на странице Models](../../images/jetbrains/jetbrains-ides-byok-models-settings.webp)

В более новой UI из вашего скриншота настройка находится в `Settings | Tools | AI Assistant | Providers & API keys`.

![Текущий экран JetBrains Providers & API keys для настройки BYOK](../../images/jetbrains/jetbrains-ides-byok-providers-api-keys.jpg)
